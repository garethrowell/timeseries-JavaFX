...
public class CuvaWellData1 extends Application {
    ...
    public void start(Stage stage) throws Exception {
		...
		// we want a X axis in the middle of the Y axis to show negative and positive depths
		...
		// display first well: Bath
		// note: row 0 contains the column names so start with row 1
		// depth values are represented as negative numbers so
		// convert to positive numbers for Java coordinate system
...
*/
		...
		stage.setTitle("Cuva Well Data: Langes");
